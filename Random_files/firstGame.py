...
#
# Purpose:  The Tech Acadamy - Python course, Creating first program.
#           Demonstrating how to pass variables from function to
#           function while producing a functional game.
#
#           Remember, function_name(variable) _means that we pass in the
